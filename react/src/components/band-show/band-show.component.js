...
export class BandShowComponent extends Component {
  ...
  componentDidMount() {
    ...
    nodeApiService.getData(`/api/band/${this.props.match.params.slug}`)
      .then((data) => {
        ...
        <Segment>
          ...
          <Segment inverted>
            <Statistic.Group widths='five'>
              ...
              <Statistic inverted color='blue'>
                <Statistic.Value>{this.state.data.musicbrainz_album_count}</Statistic.Value>
                <Statistic.Label>MusicBrainz</Statistic.Label>
              </Statistic>
              <Statistic inverted color='blue'>
          ...
          <Segment inverted>
            <Statistic.Group widths='five'>
              ...
              <Statistic inverted color='blue'>
                <Statistic.Value>{this.state.data.musicbrainz_song_count}</Statistic.Value>
                <Statistic.Label>MusicBrainz</Statistic.Label>
              </Statistic>
              <Statistic inverted color='blue'>
